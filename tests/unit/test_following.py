...
class TestFollowParameters:
    def test_passing_parameters(self):
        parameters = FollowParameters(min_posts_count=150, min_followers=500, min_followings=1000)
    ...
    def test_unpassing_parameters(self):
        parameters = FollowParameters(min_posts_count=10, min_followers=100, min_followings=100)
